...
document.addEventListener('DOMContentLoaded', function () {
	...
	// Aguarda as vantagens serem renderizadas dinamicamente
	document.addEventListener('advantagesRendered', initializeCarousel);

	// Fallback: se já existem opções no DOM
	if (section.querySelectorAll('.advantage-options .advantage-option').length > 0) {
		initializeCarousel();
	}
